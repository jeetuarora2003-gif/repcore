...
export default function HelpPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Open the member's profile, go to the Billing tab, and use the Freeze option. Set the start and end date of the freeze. Their subscription end date will automatically extend.",
    },
    {
      q: "How do I archive (remove) a member?",
      a: "Open the member's profile, go to the Overview tab, and tap \"Archive member\" at the bottom of the profile form. Add a reason and confirm. Their payment history is preserved.",
    },
    {
      q: "Managing expiring memberships",
      a: "The Dashboard shows \"Expiring this week\". Tap \"View member\" to open their profile, or go to Reminders to bulk message all expiring members at once.",
    },
  ];
